...
export class InferencePageManager {
    constructor(app) {
        this.app = app;
    ...
    renderResults(results) {
        ...
        this.elements.resultsContainer.innerHTML = `
            ...
            <div class="results-actions">
                ...
                <button class="btn btn-primary" onclick="app.saveResults()">
                    💾 Save Results
                </button>
            </div>
        `;
            ...
            <div class="result-item">
                ...
                <div class="result-value">
                    <input type="text" class="result-input" value="${Utils.sanitizeHtml(item.value || '')}" 
                           data-item-id="${item.id}" onchange="app.updateResultValue(this)">
                </div>
...
window.app.exportResults = function(format) {
...
window.app.updateResultValue = function(input) {
    const inferenceManager = window.app.getPageManager('inference');
    if (inferenceManager) {
...
window.app.saveResults = function() {
    const inferenceManager = window.app.getPageManager('inference');
    if (inferenceManager) {
