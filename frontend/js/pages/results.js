...
export class ResultsPageManager {
    constructor(app) {
        this.app = app;
        this.results = [];
            ...
            <div class="result-card" data-result-id="${result.id}">
                <div class="result-card-header">
                    ...
                    <div class="result-actions">
                        <button class="btn btn-sm btn-secondary" onclick="app.viewResult(${result.id})">
                            👁️ View
                        </button>
                        <button class="btn btn-sm btn-secondary" onclick="app.exportResult(${result.id})">
                            📤 Export
                        </button>
                        <button class="btn btn-sm btn-secondary" onclick="app.deleteResult(${result.id})">
                            🗑️ Delete
                        </button>
                    </div>
                </div>
...
window.app.viewResult = function(resultId) {
...
window.app.exportResult = function(resultId) {
    const resultsManager = window.app.getPageManager('results');
    if (resultsManager) {
...
window.app.deleteResult = function(resultId) {
    const resultsManager = window.app.getPageManager('results');
    if (resultsManager) {
