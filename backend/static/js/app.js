...
class App {
    ...
    updatePageTitle(page) {
        ...
        const titles = {
            upload: {
                title: 'Upload & Train',
                subtitle: 'Manage your training documents'
            },
            annotate: {
                title: 'Annotate',
                subtitle: 'Create annotations for training'
            },
            inference: {
                title: 'Extract',
            ...
            results: {
                title: 'Results',
                subtitle: 'View extraction results'
            }
        };

        const pageInfo = titles[page] || { title: 'OCR Studio', subtitle: 'Document Annotation' };

        const titleElement = pageTitle.querySelector('h2');
        const subtitleElement = pageTitle.querySelector('.page-subtitle');
    ...
    async initializePageManagers() {
        // Initialize page managers (classes are loaded via script tags)
